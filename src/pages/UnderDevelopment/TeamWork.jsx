...
export default function TeamWork() {
  ...
  return (
    <div className="teamWorkContainer flex justify-center items-center   bg-cover bg-no-repeat bg-center" style={{backgroundImage:`url(${heroImg})`}}>
      ...
      <div className="bottomInfoContainer  flex flex-col items-center gap-8">
        ...
        <div className="featureCardContainer border border-[#1E293B] bg-[#0D131D] flex flex-col gap-1.5 max-w-250 px-3 py-6 rounded-xl">
          ...
          <div className="featureCardsWrapper flex items-center gap-3">
            <div className="featureCard  flex flex-col p-3">
              ...
              <h3 className="text-[14px] font-medium mt-2">Invite team members</h3>
              <p className="text-[12px] text-[#94A3B8] w-40">Add team members and work together seamlessly.</p>
            </div>
            <div className="featureCard  flex flex-col p-3">
              ...
              <h3 className="text-[14px] font-medium mt-2">Manage roles & permissions</h3>
              <p className="text-[12px] text-[#94A3B8] w-40">Control access and keep your content secure.</p>
            </div>
            <div className="featureCard  flex flex-col p-3">
              ...
              <h3 className="text-[14px] font-medium mt-2">Collaborate on content</h3>
              <p className="text-[12px] text-[#94A3B8] w-40">Plan, create and review content as a team.</p>
            </div>
            <div className="featureCard  flex flex-col p-3">
              ...
              <h3 className="text-[14px] font-medium mt-2">Share templates</h3>
              <p className="text-[12px] text-[#94A3B8] w-40">Use shared templates and brand settings.</p>
            </div>
          </div>
        </div>
        ...
        <div className="smallInfoFooter  flex flex-col items-center gap-2  py-5">
          <div className="topWrapper flex items-center ">
            ...
            <p className="text-[14px] font-medium text-[#94A3B8]">We're working on something great!</p>
            <hr className="w-40 border-[#1E293B]" />
          </div>
         <div className="bottom flex flex-col items-center gap-1">
          ...
          <p className="text-[12px] font-semibold text-[#94A3B8]">The ContentPilot Al Team</p>
         </div>
        </div>
      </div>
      </div>
