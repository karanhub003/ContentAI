    ...
    <div className='AllTemplateContainer '>
        ...
        <div className="templateNavigator  flex items-center gap-2.5 p-2 mb-1">
        {
            templateCategories.map((template)=>(
                <div key={template.id} className="navigatorBox active:border-b active:border-purple-500 active:text-purple-500 p-1 cursor-pointer text-[#94A3B8] text-[14px] hover:border-b hover:border-purple-500">{template.name}</div>
            ))
        }
        </div>
    <div className="allTemplateCardWrapper grid grid-cols-[285px_285px_285px]  gap-2">
        {
