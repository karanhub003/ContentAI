...
export default function AllTemplateCard({ template }) {
  return (
    <div className="AllTemplateCardContainer flex border py-3 px-2 bg-[#0D131D] border-[#1E293B] rounded-lg gap-3 hover:border-purple-500 cursor-pointer ">
      ...
      <div className="rightSideContainer flex justify-between  gap-2">
        <div className="infoBoxStarBox flex flex-col items-start w-40 gap-2.5  ">
        ...
        <div className="btnUserBox flex flex-col justify-between items-end">
         ...
         <div className="flex items-center gap-1 pb-1 text-[#94A3B8]"><i class="fa-solid fa-users text-[9px] "></i><p className="text-[10px]">{template.uses} uses</p></div>
        </div>
      </div>
    </div>
  );
