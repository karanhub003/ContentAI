...
export default function TopPerformingContent() {
  return (
    <div className='topPerformingContainer   bg-[#0D131D]  rounded-xl p-3  flex flex-col gap-4.5'>
        <div className="topBoxContainer flex justify-between items-center ">
            <div className="infoBox flex items-center gap-2.5">
                <h2 className='text-[20px]'>Top Performing Content </h2>
            <i class="fa-solid fa-circle-info text-[#94A3B8]"></i>
            </div>
            <Button variant='outline'>View all</Button>
        </div>
    <div className="topPerformingCardWrapper flex flex-col gap-5 ">
        {
