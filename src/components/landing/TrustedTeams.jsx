  ...
  return (
    <div className="TrustedTeamsContainer  flex flex-col gap-2.5 w-345 mx-auto py-8 ">
      <div className="topWrapper flex  justify-between  items-center  ">
        <div className="leftSide w-100 flex flex-col gap-2.5">
          ...
          <div className="text-[18px] font-medium ">
            <h2 className="">Join thousands of creators, marketers</h2>  
             <h2 className="tracking-wider">and businesses growing with <span className="text-[18px] font-medium text-purple-500">Content AI.</span></h2>
          </div>
        </div>
