...
export default function BottomHero() {
  return (
    <div className='bottomHeroSectionContainer bg-cover bg-no-repeat bg-center  max-w-375 mx-auto rounded-xl border overflow-hidden border-purple-600 py-6' style={{ backgroundImage: `url(${bottomHero})` }}>
